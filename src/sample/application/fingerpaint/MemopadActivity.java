...
import sample.application.namespace.R;
import sample.application.namespace.R.id;
import sample.application.namespace.R.layout;
import sample.application.namespace.R.menu;
...
//							げっとテキストで処理行ったあとでそのオブジェクトをとうストリングで実行する。　
